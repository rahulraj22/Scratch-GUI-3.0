...
class Scratch3OperatorsBlocks {
    ...
    getPrimitives () {
        return {
            ...
            /* Operator Square added */
            operator_square: this.square,

            // for square root, we can make similarly
            operator_square_root: this.sqrt
    ...
    square(args) {
        ...
        return n*n; // or we can also use: return (n ** 2); or return (Math.pow(n, 2));
    }
    sqrt(args) {
        const n = Cast.toNumber(args.NUM);
        return Math.pow(n, 1/2); // for finding square root
    }
